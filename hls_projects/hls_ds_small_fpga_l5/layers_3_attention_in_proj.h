// Delayed Scaling | layers.3.attention_in_proj | ap_int<2> x ap_int<3> -> impl=fabric
#pragma once
#include "ap_int.h"

typedef ap_int<2>    wi_layers_3_attention_in_proj_t;
typedef ap_int<3>    ai_layers_3_attention_in_proj_t;
