// Delayed Scaling | layers.3.feed_forward.0 | ap_int<2> x ap_int<2> -> impl=fabric
#pragma once
#include "ap_int.h"

typedef ap_int<2>    wi_layers_3_feed_forward_0_t;
typedef ap_int<2>    ai_layers_3_feed_forward_0_t;
